...
# PLEASE NOTE that Diagnostic Data must be set to Full to get preview builds from Windows-Insider-Program! Just set the value of the AllowTelemetry key to "3" and run the script. All other changes remain unaffected.
...
New-ItemProperty -Path "HKCU:\Software\Microsoft\Clipboards" -Name EnableClipboardHistory -Type DWord -Value 0 -Force
