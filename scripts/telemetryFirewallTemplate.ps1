...
Remove-NetFirewallRule -DisplayName "SharpApp Microsoft Telemetry Block" -ErrorAction SilentlyContinue
New-NetFirewallRule -DisplayName "SharpApp Microsoft Telemetry Block" -Direction Outbound `
